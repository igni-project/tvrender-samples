...
Before the TVrender samples can run, they need to be installed. This section walks through the process of installing this program.
...
2. The TVrender samples are now installed and ready for use.
